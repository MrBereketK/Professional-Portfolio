...
const socialLinks = [
  {
    id: 1,
    title: "Bereket Kiros's Github Profile",
    link: "https://github.com/MrBereketK",
    svg: (
      <svg
  ...
  {
    id: 2,
    title: "Bereket Kiros's LinkedIn Profile",
    link: "https://www.linkedin.com/in/bereket-kiros-hailesilassie/",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
  ...
  },
  {
    ...
    svg: (
      <svg
        ...
        className="dark:fill-gray-400 hover:fill-accentColor dark:hover:fill-accentColor"
      >
        <path d="M2.01 6 9.4 13.27a2 2 0 0 0 2.83 0L19.99 6M20 6H4v12a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1V6z" stroke-width="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round" transform="scale(1.1) translate(0,0)"/>
      </svg>
    ),
  },
]
